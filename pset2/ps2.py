...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.cleaned = 0
        self.room = {(x, y): False for x in range(width)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                RandomWalkRobot)
    """
    # anim = ps2_visualize.RobotVisualization(num_robots, width, height) # optional delay parameter at the end (time between frames in seconds)
    trial_results = []
...
##print(runSimulation(4, 1.0, 10, 10, 0.75, 30, StandardRobot))
